...
namespace Roadkill.Tests.Integration
{
	...
	public class LightSpeedRepositoryTests
	{
		...
		public void Setup()
		{
			...
			_pageContent1 = _repository.AddNewPage(_page1, "text", "admin", _createdDate);
			_page1 = _pageContent1.Page;
			_pageContent2 = _repository.AddNewPageContentVersion(_page1, "v2", "admin", _editedDate, 2);
			_page1 = _pageContent2.Page; // update the modified date

			Page page2 = NewPage("editor1");
			PageContent pageContent2 = _repository.AddNewPage(page2, "text", "editor1", _createdDate);
			_repository.AddNewPageContentVersion(pageContent2.Page, "v2", "editor1", _editedDate, 1);

			Page page3 = NewPage("editor2");
			PageContent pageContent3 = _repository.AddNewPage(page3, "text", "editor2", _createdDate);
			_repository.AddNewPageContentVersion(pageContent3.Page, "v2", "editor2", _editedDate, 1);

			Page page4 = NewPage("editor3");
			PageContent pageContent4 = _repository.AddNewPage(page4, "text", "editor3", _createdDate);
			_repository.AddNewPageContentVersion(pageContent4.Page, "v2", "editor3", _editedDate, 1);

			Page page5 = NewPage("editor4");
			PageContent pageContent5 = _repository.AddNewPage(page5, "text", "editor4", _createdDate);
			_repository.AddNewPageContentVersion(pageContent5.Page, "v2", "editor4", _editedDate, 1);
		}
		...
		public void AddNewPage()
		{
			...
			// Act
			PageContent pageContent = _repository.AddNewPage(newPage, "my text", "admin", _createdDate);
		...
		public void AddNewPageContentVersion()
		{
			...
			// Act
			PageContent newContent = _repository.AddNewPageContentVersion(existingPage, "new text", "admin", _createdDate, 2);
		...
		{
			// Arrange
			PageContent newContent = _repository.AddNewPageContentVersion(_page1, "new text", "bob", _createdDate, 3);
		...
		public void GetPageByTitle()
		{
			...
			PageContent newContent = _repository.AddNewPage(expectedPage, "sometext", "admin", _createdDate);
