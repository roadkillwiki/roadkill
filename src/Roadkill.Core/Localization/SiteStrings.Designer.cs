...
namespace Roadkill.Core.Localization {
    ...
    public class SiteStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to View current page version.
        /// </summary>
        public static string History_CurrentVersion {
            get {
                return ResourceManager.GetString("History_CurrentVersion", resourceCulture);
            }
        }
