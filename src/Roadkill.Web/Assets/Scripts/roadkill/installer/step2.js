...
(function (Roadkill) {
    ...
    (function (Web) {
        var Installer;
        (function (Installer) {
            var Step2Messages = /** @class */ (function () {
            ...
            var Step2 = /** @class */ (function () {
                ...
                Step2.prototype.OnTestDatabaseClick = function (e) {
                    ...
                    this._wizard.makeAjaxRequest(url, jsonData, function (data) { _this.OnTestDatabaseSuccess(data); });
                };
                Step2.prototype.OnCopySqliteClick = function (e) {
                    var _this = this;
                    var url = ROADKILL_INSTALLER_COPYSQLITE_URL;
                    this._wizard.makeAjaxRequest(url, {}, function (data) { _this.OnCopySqliteSuccess(data); });
                };
